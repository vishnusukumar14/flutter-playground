...
//   List<Todo> build() {
//     return [
//       Todo.create(title: "Sample Task 1", descp: "Complete this task"),
//       Todo.create(title: "Sample Task 2", descp: "Another task to do"),
//       Todo.create(title: "Sample Task 3", descp: "Third sample task"),
//       Todo.create(title: "Sample Task 4", descp: "Fourth sample task"),
//     ];
//   }
//
//   void add(Todo todo) {
...
//   }
//
//   void _handleListChanges(List<Todo> newTodos) {
...
//   }
//
//   Widget _buildTodoCard(Todo todo, {bool isRemoving = false}) {
...
//   }
//
//   void _removeTodoWithConfirmation(Todo todo) async {
...
//   }
//
//   void _removeTodoWithFeedback(Todo todo) {
